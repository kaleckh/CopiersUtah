...
import styles from '../Screens/Epson.module.css';
		...
		<div className={styles.main}>
			...
			>
				<div className={styles.backContainer}>
					<div onClick={() => {navigate("/products")}} style={{fontSize:"25px", fontWeight:"400", cursor:"pointer"}}> {`X`}</div>
				</div>
				...
				<div className={styles.row}>
					...
					>
						...
						<button onClick={() => {setQuote(!quote)}} className={styles.button}>Request a quote</button>
					</div>
					{quote ? <Form/> : <div className={styles.column}>
						...
						<div>
							{gray ? (
								<div className={styles.paragraph} style={{ textAlign: 'center' }}>
									...
									including 22 ppm printing, color scanning, powerful finishing options for right-size
									scalability and enhanced control panel which now features a new mobile connectivity
									area.
								</div>
							) : (
								<div>
									<div className={styles.bulletContainer}>
										...
										<div className={styles.paragraphSmall}>
											The bizhub 227 multifunction printers from Konica Minolta have a print/copy
											output of up to 22 ppm to help keep pace with growing workloads
										</div>
									</div>
									<div className={styles.bulletContainer}>
										<div className={styles.bullet}>1s</div>
